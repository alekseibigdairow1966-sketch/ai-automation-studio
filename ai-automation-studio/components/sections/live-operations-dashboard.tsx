    ...
    <section className="py-14 md:py-16 px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <MotionWrapper delay={0.1}>
          <div className="bg-[#08080d] border border-white/10 rounded-2xl overflow-hidden">
            {/* ── Top Bar ── */}
            <div className="px-5 sm:px-6 py-3.5 border-b border-white/5 flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 min-h-0">
              ...
              <div className="lg:col-span-3 lg:border-r border-white/5">
                <div className="px-5 sm:px-6 py-3 border-b border-white/5">
                  <span className="text-text-primary text-sm font-medium">
              ...
              <div className="lg:col-span-2 border-t lg:border-t-0 border-white/5">
                <div className="px-5 sm:px-6 py-3 border-b border-white/5 flex items-center justify-between">
                  <span className="text-text-primary text-sm font-medium">
                    Live Activity Feed
                  </span>
